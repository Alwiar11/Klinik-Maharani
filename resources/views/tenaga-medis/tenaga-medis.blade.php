            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right"> <!-- Bagian ini untuk tombol -->
                        <button type="button" class="btn btn-primary"><span style="font-size: larger">+</span> Tenaga Medis</button>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="table-tenaga-medis" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th style="width: 350px">NAMA LENGKAP</th>
                                            <th>NOMOR TELEPON</th>
                                            <th>JENIS KELAMIN</th>
                                            <th>PERAN</th>
                                            <th></i></th>
