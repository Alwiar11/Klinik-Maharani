            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right"> <!-- Bagian ini untuk tombol -->
                        <button type="button" class="btn btn-primary"><span style="font-size: larger">+</span> Inventory</button>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="table-inventory" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>NAMA OBAT</th>
                                            <th>KODE OBAT</th>
