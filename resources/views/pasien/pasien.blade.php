            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right"> <!-- Bagian ini untuk tombol -->
                        <button type="button" class="btn btn-primary"><span style="font-size: larger">+</span> Tambah Pasien</button>
                    </div>
                </div>
            </div>
        </section>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <div class="btn-group dropleft">
                                                        <button style="border: none; background: none;" data-toggle="modal" data-target="#modal-detail-pasien-{{ $pasien->id }}"><a class="dropdown-item"
                                                                href="#"><i class="fas fa-eye"></i></a></button>
                                                        <button type="button" class="" style="border: none; background: none;" data-toggle="dropdown">
                                                            <i class="fas fa-bars"></i>
                                                        </button>

                                                        <div class="dropdown-menu">
                                                            <button style="border: none; background: none;" data-toggle="modal" data-target="#modal-edit-pasien"><a class="dropdown-item"
                                                                    href="#">Edit
                                                                    Pasien</a></button>
                                                            <button style="border: none; background: none;"><a class="dropdown-item" href="#">Reservasi</a></button>
                                                            <button style="border: none; background: none;"><a class="dropdown-item" href="#">Rekam Medis</a></button>
